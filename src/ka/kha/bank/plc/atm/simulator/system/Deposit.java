...
public class Deposit extends JFrame implements ActionListener{
    ...
    Deposit(String cardNumber,String pinNumber)
    {
        ...
        deposit.setBounds(340,385,105,24);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        else if(ae.getSource()==deposit)
        {
            ...
            else
            {
                ...
                {
                    Conn conn = new Conn();
                    String query = "insert into bank values('"+cardNumber+"','"+pinNumber+"','"+day+"','Deposit','"+taka+"')";
                    conn.s.executeUpdate(query);
                    JOptionPane.showMessageDialog(null, "BDT "+taka+" deposited successfully");
                    setVisible(false);
                    new Transactions(cardNumber,pinNumber).setVisible(true);
